...
//        resizedBitmap = Bitmap.createScaledBitmap(alteredBitmap, 3*width/4, height, false);
        ...
        animPathParent.moveTo(605, 1400);
      //  animPath.lineTo(740, 1270);
        ...
        matrixChild = new Matrix();
         Log.i("!!!!!!!!!!Dheera - ", "Parent step count =" + Pedometer.mStepValue +" Child step count ="+Pedometer.childstepcount);
    }
...
//        canvas.drawLine(1360-bm_offsetX/4,955,155-bm_offsetX/4,955,paint2);
    	...
    	y1=1400f;
    	x2=605f;
    	float temp=0.13f*Float.parseFloat(Integer.toString(Pedometer.mStepValue))*5;
    	y2=y1-temp;
    	...
    	childx1=795f;
     	childy1=1400f;
     	childx2=795f;
     	float tempchild=0.13f*Float.parseFloat(Integer.toString(Pedometer.childstepcount))*15;
